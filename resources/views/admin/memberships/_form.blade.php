...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <small class="text-muted">If left blank, the organization prefix ({{ $organization->prefix ?? 'ORG' }}) will be used.</small>
    </div>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input id="joining_fee" type="number" step="0.01" min="0" name="joining_fee"
            ...
            value="{{ $joiningFee }}">
        @error('joining_fee') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
    </div>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input id="monthly_fee" type="number" step="0.01" min="0" name="monthly_fee"
            ...
            value="{{ $monthlyFee }}">
        @error('monthly_fee') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
    </div>
