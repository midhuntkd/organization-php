...
<body class="hold-transition dark-skin theme-primary bg-img">
    ...
    @php
        $bgUrl = isset($organization) && $organization->background_image_url
            ? $organization->background_image_url
            : asset('hyper/images/auth-bg/bg-16.jpg');
    @endphp
    ...
    <div class="h-p100">
        <div class="row justify-content-md-center min-h-p100 py-4" style="background-image: url('{{ $bgUrl }}')">
                ...
                <div class="row g-0 h-p100 justify-content-center align-items-lg-center">
                    <div class="col-lg-6 h-p100 align-items-lg-center d-lg-flex justify-content-md-center d-none logo-div">
                        <a href="#" target="_blank" style="text-decoration: none;">
                            <img src="{{ $organization->logo_url }}" alt="Hyper Admin">
                        </a>
                    </div>
